...
<head>
    ...
    <title>Gürler Yapı | Admin Panel</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#refUtilities"
               aria-expanded="true" aria-controls="collapseUtilities">
                <i class="fas fa-fw fa-wrench"></i>
                <span>Site ayarları</span>
            </a>
            <div id="refUtilities" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
        ...
        <li class="nav-item">
            <a class="nav-link" href="">
                <i class="fas fa-fw fa-user"></i>
                <span>Abonelere mail gönder</span></a>
        </li>
                ...
                <form
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary"style="background-color: #282826" type="button">
...
{{--<script>--}}
{{--    $(document).ready(()=>{--}}
{{--        $(".dataCard").css("height" , $(".dataCard").width())--}}
{{--    })--}}
